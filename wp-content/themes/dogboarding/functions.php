<?php
/**
 * Dogboarding functions and definitions
 *
 * @package Dogboarding
 */
...
if ( ! function_exists( 'dogboarding_setup' ) ) :
/**
 ...
 */
function dogboarding_setup() {

	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on Dogboarding, use a find and replace
	 * to change 'dogboarding' to the name of your theme in all the template files
	 */
	load_theme_textdomain( 'dogboarding', get_template_directory() . '/languages' );
	...
	add_theme_support( 'custom-background', apply_filters( 'dogboarding_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif; // dogboarding_setup
add_action( 'after_setup_theme', 'dogboarding_setup' );
 ...
 */
function dogboarding_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'dogboarding' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'widgets_init', 'dogboarding_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'dogboarding_scripts' );
